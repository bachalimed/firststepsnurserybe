...
//     const { parentYear, child, partner } = req.body//this will come from front end we put all the fields o fthe collection here
...
//     const duplicate = await Parent.find({parentYear }).lean().exec()//because we re receiving only one response from mongoose
